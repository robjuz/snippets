...
Route::get('csv-snippet/{snippet}_{slug}', 'CsvSnippetController@show')->name('csv-snippet.show');

Route::get('text-snippets', 'TextSnippetController@index')->name('text-snippet.index');
Route::get('text-snippet/{snippet}_{slug}', 'TextSnippetController@show')->name('text-snippet.show');
//Route::get('text-snippet/{snippet}_{slug}/raw', 'TextSnippetController@raw')->name('text-snippet.raw');

Route::get('image-snippets', 'ImageSnippetController@index')->name('image-snippet.index');
Route::get('image-snippet/{snippet}_{slug}', 'ImageSnippetController@show')->name('image-snippet.show');
